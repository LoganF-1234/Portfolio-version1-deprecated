      ...
      <div class="graphics">
        <div class="tower">
          <svg version="1.1" id="Layer_1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-11 170 1000 429" enable-background="new -11 170 1000 429" xml:space="preserve">
            <g class="pillar-side">
            	<path class="path" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-miterlimit="10" d="M 48.936 574.852 V 411.738 V 291.453 V 261.153 C 48.741 261.131 48.084 261.169 47.97 261.149 C 47.533 261.131 47.61 259.065 47.607 257.996 C 47.436 257.9 46.324 241.482 46.841 218.457"/>
                 <path class="path" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-miterlimit="10" d="M 104.915 575.419 V 261.156 C 105.182 261.161 105.645 261.2 105.999 261.161 C 106.254 261.098 105.929 259.641 105.818 258.35 C 106.353 258.304 106.933 239.414 106.018 219.513"/> 
            </g> 
            <g class="left-swirl">
            ...
            <g class="pillar-base">
            	...
            	<path class="path" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-miterlimit="10" d="M 77.797 261.656 C 80.688 262.775 81.116 264.924 81.116 269.597 V 545.72 C 81.201 548.587 79.142 551.269 77.791 551.371 M 77.793 261.654 C 75.347 263.273 75.037 265.048 75.007 269.673 V 545.72 C 74.947 549.001 76.442 551.265 77.791 551.388"/>
            </g>
            <g class="">
