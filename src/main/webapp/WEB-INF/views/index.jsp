      ...
      <div class="graphics">
        <div class="tower">
          <svg version="1.1" id="Layer_1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-11 170 1000 429" enable-background="new -11 170 1000 429" xml:space="preserve">
            ...
            <g class="path-1">
           		<path class="path-1" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-miterlimit="10" d="M 1020.226 509.014 C 829.028 414.412 723.696 385.369 640.325 482.563 M 647.668 474.354 C 566.338 446.532 641.188 390.551 366.014 436.838 M 430.235 526.206 C 366.5877 478.7893 376.487 367.991 238.007 384.024 M 211.48 383.025 C 178.884 380.689 89.069 319.649 -38.997 366.892"/>
            </g>
          </svg>
        </div>
      </div>
